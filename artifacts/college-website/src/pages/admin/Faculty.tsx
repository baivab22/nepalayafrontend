...
//                               ? fac.photo
//                               : `http://localhost:8000${fac.photo.startsWith("/api/") ? fac.photo : `/api/faculty/photo/${fac.photo}`}`
//                           }
//                           alt={fac.name}
...
//                         ? viewing.photo
//                         : `http://localhost:8000${viewing.photo && viewing.photo.startsWith("/api/") ? viewing.photo : `/api/faculty/photo/${viewing.photo}`}`
//                     }
//                     alt={viewing.name}
