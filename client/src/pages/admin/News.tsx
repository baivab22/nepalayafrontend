...
export default function NewsAdmin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!stripHtml(form.description).trim()) newErrors.description = "Description is required";
                      ...
                      {paginated.map((item) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            ...
                            <div className="text-xs text-slate-400 line-clamp-1 mt-1">{stripHtml(item.description).substring(0, 60)}</div>
                          </td>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-4">
            ...
            <div>
              ...
              <div className={`border rounded-lg overflow-hidden [&_.ql-editor]:min-h-[200px] [&_.ql-editor]:text-sm [&_.ql-toolbar]:border-t-0 [&_.ql-toolbar]:border-x-0 [&_.ql-container]:border-0 ${errors.description ? "border-red-400" : "border-slate-200"}`}>
                <ReactQuill
                  theme="snow"
                  value={form.description}
                  onChange={(value) => { setForm(f => ({ ...f, description: value })); if (errors.description) setErrors((prev) => ({ ...prev, description: "" })); }}
